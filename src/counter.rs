...
/// assert_eq!(counter.current(), &Integer::from(1));
/// assert_eq!(counter.next(), &Integer::from(128));
/// ```
...
impl SequenceGenerator for Utf8Counter {
    #[inline]
...
mod tests {
    ...
    fn count_0_bytes() {
        ...
        let calculated = utf8_counter().nth(0).clone();
    ...
    fn count_1_byte() {
        ...
        let calculated = utf8_counter().nth(1).clone();
        assert_eq!(calculated, counted);
    }
    ...
    fn count_2_bytes() {
        ...
        let calculated = utf8_counter().nth(2).clone();
        assert_eq!(calculated, counted);
    }
    ...
    fn count_3_bytes() {
        ...
        let calculated = utf8_counter().nth(3).clone();
        assert_eq!(calculated, counted);
    }
    ...
    fn count_4_bytes() {
        ...
        let calculated = utf8_counter().nth(4).clone();
        assert_eq!(calculated, counted);
    }
}
